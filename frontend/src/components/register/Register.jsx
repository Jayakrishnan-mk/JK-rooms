        ...
        <div className='main'>
            ...
            <div class="card">
                <div className='heading'>
                    ...
                    <button class="button" type="submit" onClick={loginfn}>Login</button>
                </div>
                <br />
                <form onSubmit={(e) => handleSubmit(e)}>

                    <div class="field">
                        <input autocomplete="off" id="logname" placeholder="Full name" class="input-field" name="name" type="text" onChange={(e) => { setValues({ ...values, [e.target.name]: e.target.value }) }} />
                    </div>
                    ...
                    <div class="field">
                        <input autocomplete="off" id="logphone" placeholder="Phone" class="input-field" name="phone" type="text" onChange={(e) => { setValues({ ...values, [e.target.name]: e.target.value }) }} />
                    </div>
